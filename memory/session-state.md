...
Updated: 2026-06-28T15:08Z

## Latest cron run
- Job: DoomsdayWatch nuclear escalation MORNING DEEP SCAN 15Z refresh.
- Repo: `/home/openclaw/.openclaw/workspace/nuke-watch`
- Deploy pushed commit: `404bdf9` (`Update 2026-06-28T15:06:17Z — automated`).
- Final dashboard/current state: **66% / imminent**; raw global in state: **66.00** after deploy.
- Movement vs 12Z: **no probability changes**. Fresh Reuters/WSJ/Kurdistan24/MSN-style fallback corroborated Iran/Hormuz pressure, but oil/traffic fallback still rejects full waterway stoppage. Pakistan-Afghanistan and Russia-Ukraine older force signals are near 72h decay checks.
...
- Signal hygiene: canonical check clean after deploy. No noncanonical/legacy signal added. `china.active_signals=[]`; `israel_lebanon:ceasefire_violation` remains cleared.
- Source caveat: `web_search`/Tavily failed HTTP 432 on required queries. Fallback used Google News RSS for all tracker zones, direct UN/NATO probes, terminal HTTP, OilPriceAPI and Polymarket cache. Official probe: UN News RSS OK, UN Press RSS 404, NATO news/press OK, IAEA news/press 403.
- Energy/markets: OilPriceAPI 15Z Brent **$73.08**, WTI **$69.23**, gold **$4080.83**. Energy RSS shows oil falling/steady as Hormuz flows ease supply fears and tanker traffic resumes, rejecting full waterway-stoppage thresholds. Polymarket refreshed `2026-06-28T15:06:54Z`; mapped divergences remain horizon-mismatch sanity flags.
