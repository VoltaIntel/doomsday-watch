...
Updated: 2026-06-24T12:12:00Z

## Latest cron run
- Job: DoomsdayWatch nuclear escalation morning deep scan refresh.
- Repo: `/home/openclaw/.openclaw/workspace/nuke-watch`
- Final pushed HEAD: `2c0e7dd` (`Update 2026-06-24T12:07:57Z — automated`).
- Final dashboard/current state: **61% / imminent**; raw global in state: **57.5%**.
...
- Movement vs 09Z: global **61→61**. `iran_conventional` **32→30** as Hormuz traffic and crude prices eased further and coupling/decay rounded down; Israel-Lebanon evidence intensity worsened but remained capped at 100; Sudan held 78; DPRK trend remained rising/watch with no configured signal promoted.
- Signal hygiene: canonical-only clean after deploy. Active: `iran_nuclear:iaea_access_denied/iaea_emergency`, `iran_conventional:hormuz_controlled_not_closed`, `israel_lebanon:ceasefire_violation`, `pakistan_afghanistan:military_buildup`, `sudan:infrastructure_strike/military_buildup`. No noncanonical signals added; timeline keyword scan clean for known false-positive signals.
- Source caveat: `web_search`/Tavily failed HTTP 432 for 16/16 attempted query groups; fallback used Google News RSS for all configured trackers/topics, 7d/30d sparse checks, direct official/public terminal probes, UN News/NATO/EIA, Yahoo Finance, and Polymarket Gamma/cache. IAEA/OPEC direct pages returned 403/access-denied.
- Energy/markets: deploy refreshed Brent **$74.84**, WTI **$71.06**, gold **$4048.11**; independent Yahoo probe showed Brent **$74.79**, WTI **$71.07**, gold **$4071.30**; Polymarket cache refreshed `2026-06-24T12:08:37Z`; worst mapped divergence remains `israel_lebanon` (~99.4pp, horizon mismatch).
...
- Pakistan-Afghanistan: corroborated Durand Line casualty reports, Pakistani retaliation, cross-border strikes, drone losses, or confirmed force movement; 12Z includes DD News + Hans India claims, but do not inflate without broader corroboration.
